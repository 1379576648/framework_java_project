...
public class StaffController {
    ...
    public Object register(@RequestBody Map<String, Object> map) throws Exception {
        ...
        if (map2.get("成功")==null){
            ...
            map1.put("succeed",staffService.staffId(Integer.parseInt(map2.get("成功").toString())));
        }
        return  map1;
    }
    //备选方法
    ...
    public Object login(@RequestBody Map<String,Object> map){
        Map<String,Object> map1 = new HashMap<>(2);
        map1.put("state",200);
        map1.put("succeed",staffService.findStaffByPhoneAndPass(Integer.parseInt(map.get("phone").toString()),String.valueOf(map.get("pass"))));
        return map1;
    }
    //备选方法
