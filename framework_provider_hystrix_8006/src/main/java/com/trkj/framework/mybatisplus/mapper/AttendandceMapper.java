...
public interface AttendandceMapper extends BaseMapper<Attendandce> {
     ...
     * @return
     */
    @Select("SELECT distinct a.ATTENDANDCE_ID,a.ATTENDANDCE_LITEMONEY,a.ATTENDANDCE_NAME,a.ATTENDANDCE_LEAVEMONEY,a.ATTENDANDCE_DIDNOTMONEY,a.ATTENDANDCE_DIDBACKMONEY,a.ATTENDANDCE_ABSCNTMONEY,a.ATTENDANDCE_STATE,a.ATTENDANDCE_REMARK, a.IS_DELETED,d.DEPT_NAME FROM ATTENDANDCE a LEFT JOIN DEPT d on d.DEPT_NAME=a.DEPT_NAME ${ew.customSqlSegment}")
