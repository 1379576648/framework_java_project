...
public interface EmploymentTableMapper extends BaseMapper<EmploymentTable> {
     ...
     * @return
     */
    @Update("update EMPLOYMENT_TABLE set EMPLOYMENT_STATE=1 ${ew.customSqlSegment}")
    int updateEmploymentState(@Param(Constants.WRAPPER) QueryWrapper<HireVo> queryWrapper);
